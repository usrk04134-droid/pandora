...
auto Line3d::Intersect(const Plane3d &plane, bool consider_line_len) -> std::optional<Point3d> {
  ...
  return std::make_optional<Point3d>(p_int(0), p_int(1), p_int(2), this->GetRefSystem());
}
